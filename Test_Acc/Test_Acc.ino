...
void setup() 
{
  ...
  x3.begin(A3);                   // Setup SPI protocol, issue device soft reset and make a reinitialisation
  ...
  x5.begin(A5);                   // Setup SPI protocol, issue device soft reset and make a reinitialisation
