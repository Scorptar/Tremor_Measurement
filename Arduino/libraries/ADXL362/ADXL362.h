...
public:
	...
	int16_t readYData();
	int16_t readZData();
	void readAxesData(int8_t NbrAcc, int8_t &XLData, int8_t &YLData, int8_t &ZLData, int8_t &XHData, int8_t &YHData, int8_t &ZHData);
	void readXYZData(int NbrAcc, int16_t &XData, int16_t &YData, int16_t &ZData);
